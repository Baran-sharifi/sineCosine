  ...
  Button sineBtn = new Button(ButtonType.Sine, 30, 80);
  Button cosineBtn = new Button(ButtonType.Cosine, 30, 80);
  Button waveBtn = new Button(ButtonType.Wave, 30, 80);
  Button circleBtn = new Button(ButtonType.BouncingCircle, 30, 80);
  ...
  ScaleWave scaleState; // btw "scale" is not the right word... 
  ...
  void createTrigonometricCircle() {
